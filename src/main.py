...
@app.get("/categories/{rec_category}")
async def get_category(rec_category: rec_category):
    if rec_category is rec_category.anime:
        return {"category": rec_category}
    elif rec_category.value == 'genre':
        return {"category": rec_category}
    else:
        return {"category": rec_category}
